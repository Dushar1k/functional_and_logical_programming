...
let is_local_max (list:int list) i =
    if length list > (i-1) && i > 0 && list_ind list i >= list_ind list (i+1) && list_ind list i >= list_ind list (i-1) then true
    elif i = 0 && list_ind list 0 >= list_ind list 1 then true
    elif i = length list && list_ind list i >= list_ind list (i-1) then true
    else false
