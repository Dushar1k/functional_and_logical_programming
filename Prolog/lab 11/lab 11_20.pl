...
fib_up(N,X,1,1):- !.
fib_up(N,X,2,1):- !.
fib_up(N,X,I,F):- I1 is I-1, I2 is I-2, fib_up(N,X,I1,F1), fib_up(N,X,I2,F2), F is F1+F2.
fib_up(N,X):- fib_up(N,X,N,X), !.

fib_down(1,1):- !.
fib_down(2,1):- !.
fib_down(N,X):- N1 is N-1, N2 is N-2, fib_down(N1,X1), fib_down(N2,X2), X is X1+X2.
